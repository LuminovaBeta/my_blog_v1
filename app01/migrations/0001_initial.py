    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collects', models.ManyToManyField(blank=True, to='app01.articles', verbose_name='收藏的文章')),
                ('avatar', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app01.avatars', verbose_name='用户头像')),
                ('navs', models.ManyToManyField(blank=True, to='app01.navs', verbose_name='收藏的网站')),
            ],
            options={
