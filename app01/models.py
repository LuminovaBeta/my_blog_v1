...
class Articles(models.Model):
    ...
    recommend = models.BooleanField(verbose_name='是否上推荐', default=True)# 相当于放到前面，推荐文章，在文章位上有6个
...
class Comment(models.Model):
    ...
    parent_comment = models.ForeignKey('self', null=True, blank=True, on_delete=models.CASCADE, verbose_name='是否是父评论')# 父评论删除，子评论都会删除
